...
export const makeAddUserRequest = (
 Type,
 Body,
 alreadyInUse,
 setModal,
...
export const makeCurrentUserRequest = (
 Type,
 Body,
 setCurrentUser,
 setLoggedin,
...
export const makeSpecificPersonRequest = (
 Type,
 person_id,
 setLoading,
 setPerson,
...
export const makeUpdateUserRequest = (
 Type,
 id,
 Body,
 setLoggedin,
...
export const makeRemoveUserRequest = (
 Type,
 id,
 setLoggedin,
 _,
...
export const makeChangeProfiePasswordRequest = (
 Type,
 id,
 setLoggedin,
 setChangedPopUp,
 setIsOldPasswordTrue,
 Body,
 resetPassword
) => {
...
export const makeAddReportRequest = (
 Type,
 Body,
 setReportAdded,
 setLoggedin,
...
export const makeSpecificReportRequest = (
 Type,
 id,
 setLoading,
 setInitialReport,
 ...
 axios[Type]("/api/profile/report/" + id)
  .then(res => {
   ...
   if (specificReport) {
    ReactDOM.unstable_batchedUpdates(() => {
     setInitialReport(prevState => ({
      ...prevState,
      ...specificReport,
      owner: specificReport.owner || {},
     }));
     reIsetInitalReport(prevState => ({
      ...prevState,
      ...specificReport,
      owner: specificReport.owner || {},
     }));
...
export const makeUpdateReportRequest = (
 Type,
 id,
 updatedData,
 setLoggedin,
 setInitalReportState,
 reIsetInitalReportState,
 setUpdatedModal,
 setDisable
) => {
...
export const makeReportSearchRequest = (
 Type,
 searchData,
 setLoggedin,
 setReport,
...
export const makePersonSearchRequest = (
 Type,
 searchData,
 setLoggedin,
 setReport,
...
export const makeSubBranchRequest = (Type, id, setSubBranches) => {
 axios[Type]("/api/user/subBranch/" + id, {
  headers: {Authorization: `Bearer ${localStorage.getItem("auth_token")}`},
 })
  .then(res => {
...
export const makeRelatedAgencyRequest = (
 Type,
 id,
 setLoading,
 setRelatedAgency,
...
export const makeStudentSearchRequest = (
 Type,
 searchData,
 setLoggedin,
 setReport,
...
export const makeUpdateStudentRequest = (
 Type,
 data,
 id,
 setUpdatedStudent,
 ...
 axios[Type]("/api/register/student/" + id, data, {
  headers: {Authorization: `Bearer ${localStorage.getItem("auth_token")}`},
 })
...
export const makeDeleteStudentRequest = (
 Type,
 id,
 setBackStageLoading,
 setModalType
...
export const makeSendForConfirmationRequest = (
 Type,
 id,
 setUpdatedStudent,
 setBackStageLoading,
 ...
 axios[Type](
  "/api/register/send_confirmation/" + id,
  {},
  {headers: {Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}
 )
  .then(response => {
...
export const makeConfirmStudentRequest = (
 Type,
 id,
 setUpdatedStudent,
 setBackStageLoading,
 ...
 axios[Type](
  "/api/register/confirm_student/" + id,
  {},
  {headers: {Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}
 )
  .then(response => {
...
export const makeDeleteFileRequest = (
 Type,
 id,
 fileWillBeDeleted,
 setUpdatedStudent,
...
export const makeUploadFileRequest = (
 Type,
 id,
 file,
 setUpdatedStudent,
...
export const makePaymentScheduleRequest = (
 Type,
 id,
 data,
 setUpdatedStudent,
 ...
 axios[Type](
  "/api/register/add_paymentschedule/" + id,
  data,
...
export const makeAddNewStudentRequest = (
 Type,
 mainData,
 setBackStageLoading,
 setModalType,
 ...
 return axios[Type](
  "/api/register/addNewStudent",
  {mainData, studentModel},
  {headers: {Authorization: `Bearer ${localStorage.getItem("auth_token")}`}}
 )
 .then(response => {
...
export const makeUpdateNewAddedStudentRequest = (
 Type,
 Body,
 activeCircle,
 backStage,
 ...
 axios[Type]("/api/register/updateNewAddedStudent", Body)
  .then(data => {
...
export const makeSpecificStudentRequest = (
 Type,
 id,
 setLoading,
 setStudent
